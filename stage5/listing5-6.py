...
from listing5_5 import load_common_words


def gen_products(common_words: List[str],
                 brand_id_start: int, brand_id_end: int,
...
async def main():
    ...
    product_tuples = gen_products(
        common_words, brand_id_start=1, brand_id_end=100,
    ...
    sku_tuples = gen_skus(product_id_start=1,
                          product_id_end=1000, skus_to_create=100000)
